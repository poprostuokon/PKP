...
-- -----------------------------------------------------------------------------
-- Log śledzenia utrudnień LIVE (SILVER): historia utrudnień per kurs na stacji,
-- w modelu SCD2 - flaga is_active wskazuje bieżącą wersję. Wykrywanie zmian po
-- change_hash; utrudnienie może być kodem ze słownika lub samym komunikatem.
-- Partycjonowane miesięcznie po operating_date.
-- =============================================================================

CREATE TABLE silver.DISRUPTION_TRACKING_LOG (
