...
-- -----------------------------------------------------------------------------
-- Warstwa SILVER: nagłówki utrudnień w ruchu pociągów. Jeden wiersz na
-- utrudnienie - opisane kodem ze słownika przyczyn lub samym komunikatem
-- (oba mogą być null osobno). Pozycje (dotknięte przystanki) trzyma
-- disruption_details. Znacznik snapshot_ts pochodzi z pola generatedAt (UTC).
-- =============================================================================
