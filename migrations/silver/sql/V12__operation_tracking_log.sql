...
-- -----------------------------------------------------------------------------
-- Log śledzenia operacji LIVE (SILVER): historia stanu kursów na stacji, wersja
-- dopisywana przy każdej zmianie (append-only wg change_hash). Rejestruje status
-- kursu, rzeczywiste czasy przyjazdu/odjazdu, opóźnienia oraz flagi potwierdzenia
-- i odwołania. Partycjonowany miesięcznie po operating_date.
-- =============================================================================
